...
public interface GuestMapper {
	...
	@Update("update guest set guest_name=#{guestName},guest_date=sysdate,guest_email=#{guestEmail},guest_homepage=#{guestHomepage},guest_title=#{guestTitle},guest_content=#{guestContent} where guest_no=#{guestNo}")
	...
	@ResultType(Guest.class) //안써도되긴함 반환타입보고 알아서 해줌
