	...
	if(cookies!=null){
		for(Cookie cookie:cookies){
			if(cookie.getName().equals("searchKeyword")){
				System.out.println("["+request.getRemoteAddr()+"]가 전송한 쿠키 이름:"+cookie.getName());
				System.out.println("["+request.getRemoteAddr()+"]가 전송한 쿠키 값:"+cookie.getValue());
				previousSearchKeyword=URLDecoder.decode(cookie.getValue(), "UTF-8");
			}
		}
	}
%>    
