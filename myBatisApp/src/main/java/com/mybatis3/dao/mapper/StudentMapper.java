...
public interface StudentMapper {
	...
	*/
	...
	@Results({
		...
		@Result(column = "ADDR_ID",property = "address",one = @One(select = "com.mybatis3.dao.mapper.AddressMapper.findAddressById"))
	})
	@Select("select stud_id,name,phone,email,dob from students where stud_id=#{studId}")
	...
	**************************************************/
	...
	@SelectKey(before = true,
				...
				keyProperty = "studId",statement = "select students_stud_id_seq.nextval from dual")
